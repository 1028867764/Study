...
void main() {
  ...
  for (var category in factories.keys) {
    for (var factory in factories[category]!) {
      var id = factory['id'];
      var nameFirst = factory['name']![0];

      // 创建Markdown文件名
      var fileName = '${id}_markdown_1_${nameFirst}.md';
...
''';
      ...
      // 将Markdown内容写入文件
      File(fileName).writeAsStringSync(markdownContent);
      print('生成文件: $fileName');
    }
  }
}
